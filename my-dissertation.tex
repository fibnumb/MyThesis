...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Jet Cross-Sections at 8 TeV with the ALICE Experiment. }	% title of thesis/dissertation
\author{Andrew John Castro}                			% author's name
\copyrightYear{2019}            				% copyright year of your thesis/dissertation
\graduationMonth{October}           				% month of graduation for your thesis/dissertation
...
%  }
    ...
    \include{chapters/chapter-2} %\label{ch:qcd}
    \include{chapters/chapter-3}%\label{ch:alice}
    \include{chapters/chapter-4}%\label{ch:tpcu}
    \include{chapters/chapter-5}% \label{ch:data}
    \include{chapters/chapter-6}%\label{ch:error}
    \include{chapters/chapter-7}%\label{ch:cando}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % BIBLIOGRAPHY
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

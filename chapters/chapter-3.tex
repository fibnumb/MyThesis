...
\begin{figure}[h]
\includegraphics[width=11.0cm]{1920px-Cern-accelerator-complex}
\centering
...
\begin{figure}[h!]
\includegraphics[width=13.0cm]{ALICE-event-b}
\centering
...
\begin{figure}[h]
\includegraphics[width=10.0cm]{alice-tpc-schematic}
\centering
...
In order to reconstruct the trajectory of a particle, an iterative process known as the Kalman filter approach is deployed.  The x-y coordinate which is perpendicular to the beamline is determined via the signal induced on the copper pads.  The z component which is parallel to the beamline is reconstructed using the timing information from the T0.  
...
\begin{figure}[h]
\includegraphics[width=10.0cm]{ALICEEMCAL}
\centering
...
\begin{figure}[h]
\includegraphics[width=10.0cm]{Alice-EMCal-Performance}
\centering
...
\noindent
As seen in Figure \ref{eq:EMCalres} excellent agreement exits between the measured performance of the EMCal compared to simulations in a kinematic range between $10 GeV - 100 GeV$.  The stochastic term, A, is the largest source of uncertainty in the energy resolution due to the EMCal being a sampling calorimeter.  Unlike the TPC, the resolution improves at high-$p_{t}$ making the EMCal ideal for measuring high energy particles and jets.
...
\begin{figure}[h]
\includegraphics[width=10.0cm]{2017-Jul-05-Ecluster_emcal_alice_style}
\centering

...
\subsection{Jet Production and the Factorization Theorem}\label{sec:fac}
...
The Herwig Monte Carlo generator is a \verb|FORTRAN 77| package that generates pp events.  It is similar to PYTHIA in that it does the LO hard scattering of partons, however it uses the cluster model of hadronization to produce jets based on gluon splitting.  It 

...
Only a fraction of charged tracks generated by the hard scattering of two protons will be detected in the TPC due to finite track efficiency.  Missing tracks from a event will cause a JES 
...
\subsubsection{Trigger Systematic}

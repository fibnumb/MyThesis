...
\afterpage{%
\begin{figure}
\includegraphics[width=\linewidth]{tracketaall}
\centering
\caption{Hybrid track $\eta$ distribution.}
\label{fig:tracketa}
\end{figure}

\begin{figure}
\includegraphics[width=\linewidth]{trackphiall}
\centering
\caption{Hybrid track $\phi$ distribution.}
\label{fig:trackphi}
\end{figure}

\begin{figure}
\includegraphics[width=\linewidth]{trackpTresoluyion}
\centering
...
\begin{figure}
\includegraphics[width=\linewidth]{trackyieldall}
\centering
...
\begin{figure}[t!]
\includegraphics[width=\linewidth]{jetrejectionreason}
\centering
